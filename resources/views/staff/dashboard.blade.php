...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="nav-align-top mb-4">
            <ul class="nav nav-tabs nav-fill" role="tablist">
                ...
                <li class="nav-item">
                    <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#menu-1" aria-controls="menu-1" aria-selected="true">
                        <i class="tf-icons bx bx-message-alt-detail"></i> Pesanan Masuk
                        <span id="pendingNotif" class="badge rounded-pill badge-center h-px-20 w-px-20 bg-label-success">0</span>
                    </button>
                </li>
                <!-- Menu 2 - Pesanan Perlu Disiapkan -->
                <li class="nav-item">
                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#menu-2" aria-controls="menu-2" aria-selected="false">
                ...
                <li class="nav-item">
                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#menu-3" aria-controls="menu-3" aria-selected="false">
                        <i class="tf-icons bx bx-send"></i> Perlu Dikirim
                        <span id="dikirimNotif" class="badge rounded-pill badge-center h-px-20 w-px-20 bg-label-primary">0</span>
                    </button>
                </li>
            </ul>
    ...
    <div class="modal fade" id="detailKonfirmasiModal" tabindex="-1" role="dialog" aria-labelledby="detailKonfirmasiModalLabel" aria-hidden="true">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group number-spinner">
                                    <input type="text" class="form-control text-center" value="3" id="barang-1" name="barang-1" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-4">
                                <div class="input-group number-spinner">
                                    <input type="text" class="form-control text-center" value="2" id="barang-2" name="barang-2" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response.pesanan, function(index, pesanan) {
                        ...
                        var nameLabelCol = $('<div class="col-6"><label for="label">Tanggal</label></div>');
                        ...
                        var detailValueCol = $('<div class="col-6"><p id="detail">: <button type="button" class="btn btn-sm btn-primary" id="btnDetail" data-pesanan-id="' +
                            pesanan.id + '" data-bs-toggle="modal" data-bs-target="#detailKonfirmasiModal"><i class="bx bx-show"></i></button></p></div>');
                        var hr = $('<hr>');
